document.addEventListener('DOMContentLoaded', function() {
  ...
  // remove the event listener from the ProductImages HTML element when it's not needed
  // based on some condition, e.g., when the task is completed
  function removeProductImagesEventListener() {
  ...
  function handleClick(event) {
      ...
      // search our array of products for the product object that matched the alt
  ...
  function renderNewProducts() {
      // generate a random index between 0 and the length of our products array
  ...
  function viewChart() {
      ...
      removeProductImagesEventListener(); // Remove event listener after viewing the chart
  }
});
